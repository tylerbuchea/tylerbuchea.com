...
import { WrapperConnection } from "@/utils/compressed/WrapperConnection";
import { mintCompressedNFT } from "@/utils/compressed/compression";
import {
  loadKeypairFromFile,
  loadOrGenerateKeypair,
  loadPublicKeysFromFile,
  printConsoleSeparator,
} from "@/utils/compressed/helpers";
...
(async () => {
  ...
  */
  ...
  console.log(
    `Minting a single compressed NFT to ${testWallet.publicKey.toBase58()}...`
  );
